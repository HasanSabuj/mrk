  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        ...
        <a class="btn btn-primary btn-xs" href="<?php echo base_url('department-list');?>">Department List</a>
      <?php endif;?>
      ...
      <div class="x_content">
        <form class="form-horizontal form-label-left" novalidate method="post" action="<?php echo base_url('department-update');?>">
