<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        <form class="form-horizontal" method="post" action="<?php echo base_url('product-insert');?>" enctype="multipart/form-data">
          <div class="form-group">
          <label for="name">Name <span class="required">*</span>
            </label>
          <input id="name" class="form-control col-xs-12" required type="text" name="name" value="<?php echo set_value('name');?>">
        </div>
        <div class="form-group">
          ...
          <select name="requirement_form_id" id="requirement_form_id" class="form-control col-xs-12" required>
            ...
            <?php
              foreach ($forms as $key => $value) {
                echo'<option value="'.$value->id.'" '.(set_value('requirement_form_id')==$value->id?'selected':'').'>'.$value->name.'</option>';
              }
            ?>
          </select>
        </div>
