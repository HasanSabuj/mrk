<form method="post" action="<?=base_url('job-insert')?>" enctype="multipart/form-data">
<div class="row">
	<div class="col-xs-12">
	...
	<div class="col-xs-12">
		<div class="form-group">
			...
			<select name="type" class="form-control">
				...
				<option value="2">Capital Mechineries</option>
				<option value="3">Metarial Handling Dept</option>
			</select>
		</div>
		<div class="form-group">
			<label>Custom Job Number:</label>
			<input type="text" name="custome_no" class="form-control">
		</div>
		<div class="form-group">
			...
			<div class="input-group">
	            ...
	            <span class="input-group-addon" id="clear_customer_list">
	              <a href="<?=base_url('customer-add')?>" target="_blank"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span></a>
	            </span>
            </div>
		...
		<div class="form-group">
			<input type="button" id="select_product" value="Select Product" class="btn btn-success" data-toggle="modal" data-target="#job_product">
		</div>
		<div class="col-md-12" id="selected_product_result">

			<?php
			$data=$this->session->userdata('cart_products');
			if(count($data)>0){
		...
		<div class="form-group">
			...
			<textarea name="job_details" class="form-control"></textarea>
		</div>
		<div class="form-group">
	...
	<div class="col-xs-12 text-center">
		<input type="submit" name="save" value="Create Job" class="btn btn-success">
	</div>
</div>
</form>
