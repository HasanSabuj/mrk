<div class="row">
    ...
    <div class="x_panel">
      ...
      <div class="x_content">
        <?php
          if($service_details[0]->products){
            $sql="select group_concat(name SEPARATOR '<br> ') as product_name from products where id in(".$service_details[0]->products.")";
        ...
        <table class="table table-bordered">
          ...
          <tr>
            <td>SR-<?=$service_details[0]->id?></td>
            <td><?=$items?></td>
            <td><?=$service_details[0]->customer_name?></td>
            <td><?=$service_details[0]->contact_name?></td>
            <td><?=$service_details[0]->user_name?></td>
            <td><?=date("d/m/Y",strtotime($service_details[0]->created_at))?></td>
          </tr>
        </table>
      </div>
    </div>
...
<div class="row">
  <div class="col-md-3 col-sm-6 col-xs-12">
    <h3>Add New Event</h3>
    <form method="post" action="<?=base_url('service-event-save/'.$service_details[0]->id)?>" enctype="multipart/form-data" id="event_add_form">
      <input type="hidden" value="<?=$service_details[0]->id?>" name="service" id="service_id">
      ...
      <input type="button" name="save" value="Save" class="btn btn-success pull-right" id="save_service_event">
